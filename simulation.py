...
def main():
    ...
    jidxs = [discovered.get(k, (None, None))[1] for k in j_order]
    joints_prev = None
    ...
    while True:
        ...
        if driver is not None:
            ...
            jvals = [(sol[j] if j is not None else 0.0) for j in jidxs]
            ...
            if len(contacts) > 0 and joints_prev is not None:
